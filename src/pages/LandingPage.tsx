...
export const LandingPage: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'É muito simples: acesse o perfil da sua empresa no Google pelo próprio buscador ou Google Maps, clique em "Solicitar avaliações" e copie o link curto gerado pelo Google. Basta colar no painel da AvaliaTag.',
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              Como funciona a plataforma AvaliaTag
            </p>
